    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks2 = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(Register2.this, "Verification code has been sent to your Number!", Toast.LENGTH_SHORT).show();
        ...
        tvLogin2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Register2.this,Main2Activity.class));
            }
        });
        ...
        tvResendCode2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        Register2.this,               // Activity (for callback binding)
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        mDatabase2.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful()){
                                                    Toast.makeText(Register2.this, "Registration Successfull!!", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(Register2.this,HomeActivity.class));
                                                }
                                                else{
                                                    Toast.makeText(Register2.this, "Cannot create your account. Please check the form and try again", Toast.LENGTH_LONG).show();
                                                    Log.e(TAG, "onComplete: " + task.getException());
                                                }
                                            }
                                        });
                                    } else {
                                        Toast.makeText(Register2.this,task.getException().getLocalizedMessage() , Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
                else if(!edNewPassword2.getText().toString().equals(edConfirmNewPassword2.getText().toString())){
                    Toast.makeText(Register2.this, "Password Don't Match!", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(Register2.this, "All fields are necessary!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnSendOTP2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!edNewMobNum2.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(Register2.this, "Enter the Mobile Number!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnVerify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!edCode2.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(Register2.this, "Enter Verification Code!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(Register2.this, "Invalid Code!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
